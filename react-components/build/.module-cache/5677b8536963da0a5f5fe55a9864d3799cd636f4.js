...
var Macro = React.createClass({displayName: 'Macro',
  ...
  toggleExpanded: function() {
    $( this.refs.list.getDOMNode() ).toggleClass("expanded");
  },
  ...
  render: function() {
    ...
    return (React.DOM.div({className: "RegisterMachine-Macro"/*onMouseEnter={ this.showInstructions } onMouseOut={ this.hideInstructions }*/}, 
      React.DOM.div({className: "RegisterMachine-Macro-Header"}, 
